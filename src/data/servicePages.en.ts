...
export const servicePagesEn: ServicePageData[] = [

  {
    ...
    pageTitle: "Drain Cleaning Services in Sunrise, FL | JMS Plumbing",
    metaDescription: "Professional drain cleaning in Broward, Miami-Dade & Palm Beach Counties. Clogs, hydro flushing & drain pump outs cleared fast. Call JMS Plumbing at (954) 910-6883.",
  ...
  },
  {
    ...
    pageTitle: "Gas Line Installation & Repair in Sunrise, FL | JMS Plumbing",
    metaDescription: "Licensed gas line installation, repair & leak detection in South Florida. Safety-certified technicians, upfront pricing. Call JMS Plumbing at (954) 910-6883.",
  ...
  },
  {
    ...
    pageTitle: "Plumbing Repairs & Replacements | JMS Plumbing Sunrise, FL",
    metaDescription: "Expert plumbing repairs in Broward, Miami-Dade & Palm Beach Counties. Leak detection, pipe repair & fixture replacement with upfront pricing. Call JMS Plumbing at (954) 910-6883.",
    ...
    extraSection: {
      heading: "Slab Leaks, Repiping, and Pressure Regulators — South Florida Specific Problems",
      paragraphs: [
        "Three plumbing issues come up more often in South Florida than almost anywhere else in the country — and all three are worth understanding before they catch you off guard.",
        "Slab Leaks — South Florida homes are built on concrete slab foundations with water supply lines running underneath. When one of those lines develops a leak, the water has nowhere to go except through the slab and into your home. Signs of a slab leak include warm spots on your floor, the sound of running water when everything in the house is off, a water bill that's suddenly higher than usual, or cracks appearing in your flooring or baseboards. Slab leaks do not fix themselves and they do not stay small. In South Florida's humidity, a slow slab leak can cause significant structural damage and mold growth within days of going undetected. If you suspect one, call us immediately.",
        "Whole-Home Repiping — Homes built throughout Broward, Miami-Dade, and Palm Beach Counties before the mid-1980s were commonly plumbed with galvanized steel pipe. Galvanized pipe corrodes from the inside out — slowly narrowing the interior diameter, reducing pressure throughout the house, and eventually failing at joints and connections. If your home has consistently low water pressure, discolored water when you first turn on a tap, or a history of pinhole leaks in multiple locations, the pipe itself is likely the problem. Repiping replaces the entire supply system with modern PVC or PEX — resolving the underlying issue rather than patching individual failures one at a time. It's a significant job, but in the right situation it's the most cost effective long-term solution available.",
        "Pressure Regulators — Most South Florida homes have a pressure reducing valve on the main supply line that keeps water pressure at a safe level for your fixtures and appliances. When that regulator fails — and they do fail, typically after eight to twelve years — pressure throughout the house either drops noticeably or spikes high enough to damage fixtures, appliances, and pipe connections. If you're experiencing sudden pressure changes throughout your home, a failing pressure regulator is one of the first things worth checking. Replacement is straightforward and significantly less expensive than the appliance and fixture damage that unregulated high pressure causes over time.",
      ],
    },
    ...
    faqs: [
      ...
      { question: "Do you handle slab leaks in South Florida?", answer: "Yes. Slab leaks are one of the more common plumbing emergencies we handle throughout Broward, Miami-Dade, and Palm Beach Counties. Signs include warm spots on your floor, the sound of running water when nothing is on, unexplained spikes in your water bill, or new cracks in flooring or baseboards. If you suspect a slab leak call us at (954) 910-6883 immediately — these don't stay small and South Florida's humidity makes the window for addressing them without significant damage short." },
      { question: "My home has galvanized pipes. Do I need to repipe?", answer: "Not necessarily right now — but it depends on the condition and age of your system. If you're experiencing consistently low pressure throughout the house, discolored water, or recurring leaks in multiple locations, the pipe itself is likely the source and repiping is worth a serious conversation. We assess the system honestly and tell you whether targeted repairs make sense or whether the whole-home picture points to repiping as the more cost effective long-term solution." },
    ],
    relatedServices: [
  ...
  },
  {
    ...
    pageTitle: "Plumbing Remodel Services | JMS Plumbing | Sunrise, FL",
    metaDescription: "Full bathroom & kitchen plumbing remodels across South Florida. Shower pans, valves, fixture installs & complete gut remodels. Call JMS Plumbing at (954) 910-6883.",
  ...
  },
  {
    ...
    pageTitle: "Backflow Prevention Testing & Repair | JMS Plumbing FL",
    metaDescription: "Certified backflow prevention testing, installation & repair in Broward County. Annual inspections, code-compliant & documented. Call JMS Plumbing at (954) 910-6883.",
  ...
  },
  {
    ...
    pageTitle: "24/7 Emergency Plumber in Sunrise, FL | JMS Plumbing",
    metaDescription: "Emergency plumbing 24/7 across South Florida. Burst pipes, gas leaks & flooding — fast response, upfront pricing. Call JMS Plumbing at (954) 910-6883 now.",
    ...
    postExpectSection: {
      heading: "Hydro Flush — When a Standard Snake Won't Cut It",
      paragraphs: [
  ...
  },
  {
    ...
    pageTitle: "Water Heater Repair & Replacement | JMS Plumbing Sunrise, FL",
    metaDescription: "Water heater repair, replacement & installation in South Florida. Tankless, gas, electric & hybrid models. Same-day service available. Call JMS Plumbing at (954) 910-6883.",
  ...
  },
  {
    ...
    pageTitle: "Septic & Leach Field Services | JMS Plumbing Sunrise, FL",
    metaDescription: "Licensed septic system repair & leach field services in South Florida. Inspections, pump outs & repairs available. Call JMS Plumbing Services at (954) 910-6883.",
  ...
  },
  {
    ...
    pageTitle: "Toilet, Faucet & Pipe Repairs | JMS Plumbing Sunrise, FL",
    metaDescription: "Fix running toilets, dripping faucets & leaking pipes in South Florida. Fast, affordable service from JMS Plumbing. Call (954) 910-6883 today.",
