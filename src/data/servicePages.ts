...
export const servicePages: ServicePageData[] = [
  {
    ...
    pageTitle: "Drain Services | JMS Plumbing in Broward, Miami-Dade & Palm Beach Counties",
    metaDescription: "Drain services in Broward, Miami-Dade & Palm Beach Counties. Drain cleaning, hydro flush, and septic & storm drain pump outs. JMS Plumbing — call (954) 910-6883.",
    heroH1: "Your Drain Is Telling You Something. We'll Figure Out What.",
    heroSubtext: "Most drain problems in South Florida aren't just hair and soap scum. Hard water, aging cast iron pipes, and tree roots make drain issues here different — and harder to permanently fix without knowing what's actually causing them. JMS diagnoses the real cause and clears it right the first time.",
    defaultServiceValue: "drain",
    introHeading: "Drain Services in South Florida — The Right Fix for the Right Problem",
    paragraph1: "Here's something most plumbing websites won't tell you: a bottle of Drano and a professional drain service are solving two completely different problems. The bottle might buy you a few days. But if your drain keeps backing up — weekly, monthly, or every few months no matter what you pour down it — something else is going on inside that pipe. Until you find out what it is the clog is coming back.",
    ...
    paragraph3: "When you call JMS we don't just run a snake down the drain and call it done. We find out why it's happening. We tell you what we found in plain language — not to scare you into a bigger job, but because you deserve to know what's going on in your own home. Then we give you a clear price, clear the line properly, and leave the area cleaner than we found it.",
    signsHeading: "Signs Your Drain Needs Professional Attention",
    signs: [
    ...
    diyHeading: "Standard Drain Cleaning, Hydro Flush, and Pump Outs",
    diyParagraphs: [
      "Standard Drain Cleaning — For most everyday blockages like hair, soap scum, grease, and light debris, professional drain cleaning with the right equipment clears the line completely and restores full flow. Unlike store-bought chemical treatments that only address the surface of a blockage, professional drain cleaning physically removes the obstruction and inspects the line for any underlying issues that could cause the problem to return. At JMS every drain cleaning starts with understanding what caused the blockage. A kitchen drain that backs up repeatedly isn't just a grease problem — it's often a pipe slope issue, scale buildup narrowing the interior, or a partially collapsed line. Standard drain cleaning is the right call for first time blockages, slow draining fixtures, kitchen drains with grease or food debris, and bathroom drains blocked by hair and soap.",
      "Hydro Flush — Some blockages are too severe, too deep, or too embedded in the pipe walls for a standard drain snake to fully resolve. Hydro flushing uses high pressure water to blast through blockages completely and scour the interior walls of the pipe clean — removing grease buildup, mineral scale, biomat, and debris that a mechanical snake can only partially clear. In South Florida hydro flushing is particularly effective on the hard water mineral scale and grease buildup that accumulates inside older pipes throughout Broward, Miami-Dade, and Palm Beach Counties. It's also one of the most effective tools for clearing root intrusion in sewer lines. Hydro flushing makes sense for recurring blockages, severely backed up main sewer lines, heavy grease buildup, mineral scale accumulation, root intrusion, and pre-inspection cleaning before a camera inspection.",
      ...
      "Septic and Storm Drain Pump Outs — Drain problems aren't always inside the house. When your septic tank or storm drains are the source of the issue, clearing the line inside your home only addresses a symptom of a larger problem outside it. JMS handles septic and storm drain pump outs throughout the Tri-County area as part of our full drain services offering. Regular septic pump outs are the single most important maintenance step for extending the life of your system — most South Florida households should have their septic tank pumped every three to five years. Storm drain pump outs remove accumulated debris and sediment that restricts flow and creates flooding risk during South Florida's intense rainy season. For the full scope of our licensed septic services — including leach field repairs, septic inspections, and complete system assessments — visit our Septic Services page.",
    ],
    expectHeading: "What Happens When You Call JMS for Drain Services",
    steps: [
      { title: "You Call and Describe What's Happening", description: "No voicemail, no call center. We ask the right questions so we show up with the right equipment for your specific drain situation." },
      { title: "We Diagnose First, Price Before We Start", description: "We find out why it's happening — not just where it is. You get a clear upfront price before we do anything. No pressure, no surprises." },
    ...
    faqHeading: "What South Florida Homeowners Ask About Drain Services",
    faqs: [
      { question: "Why does my drain keep clogging even after I've cleared it?", answer: "Recurring clogs almost always mean the blockage isn't fully cleared or something structural is causing it. In South Florida the most common culprits are mineral scale buildup narrowing the inside of older pipes, tree roots that have partially entered a sewer line joint, or a section of deteriorating cast iron that's catching debris. A professional drain service with the right equipment will clear the full blockage and identify whether the pipe itself needs attention before it becomes a bigger problem." },
      { question: "What is the difference between standard drain cleaning and hydro flushing?", answer: "Standard drain cleaning uses a mechanical snake to physically break through or pull out a blockage. Hydro flushing uses high pressure water to blast through the blockage completely and scour the pipe walls clean. Standard cleaning is the right tool for most everyday blockages. Hydro flushing is the right tool when blockages keep coming back, when there is heavy mineral scale or grease coating the pipe walls, or when root intrusion is causing a sewer line backup. At JMS we assess the situation first and recommend the right method for your specific pipe and blockage." },
      { question: "How much does drain service cost in Broward County?", answer: "It depends on what's causing the problem and which service is needed. A standard drain cleaning costs considerably less than a hydro flush on a main sewer line. At JMS we give you a clear upfront price after assessing the situation so you know exactly what you're paying before any work begins. Call us at (954) 910-6883 for a same day assessment." },
      { question: "Can tree roots really get into drain pipes in South Florida?", answer: "More often than most homeowners expect. South Florida's combination of warm temperatures, high moisture, and sandy soil creates near perfect conditions for aggressive root growth. Roots are drawn to the moisture and nutrients inside sewer lines and can enter through the smallest cracks or joints in older pipes — particularly cast iron which becomes brittle and develops gaps over time. Once inside roots grow quickly and can cause partial or complete blockages. Hydro flushing is one of the most effective tools for clearing root intrusion and restoring flow." },
      { question: "Do you offer same day drain services in Sunrise, Fort Lauderdale, and surrounding areas?", answer: "Yes. We offer same day drain services throughout Broward County including Sunrise, Fort Lauderdale, Plantation, Coral Springs, Tamarac, Lauderhill, and Weston. Call us at (954) 910-6883 and we'll get someone out to you as fast as possible — often the same morning or afternoon you call." },
      { question: "How do I know if my drain problem is actually a septic issue?", answer: "If you have a septic system and are experiencing slow drains throughout the entire house at the same time, sewage odors in your yard, or soggy ground above your drain field, the problem is likely originating from the septic system rather than the drain lines inside your home. Clearing interior drain lines won't solve a septic system problem. Call us and we'll assess the full picture — we are licensed for both drain services and septic work throughout the Tri-County area." },
    ],
    relatedServices: [
      { title: "Septic Services", description: "Drain problems that originate outside the house require licensed septic expertise. We handle leach field repairs, septic inspections, and pump outs throughout South Florida.", href: "/septic-leach-fields" },
      { title: "Emergency Plumbing", description: "Severe drain backup or sewer line blockage that can't wait? We answer nights, weekends, and holidays with after hours fees always disclosed upfront.", href: "/emergency-plumbing" },
      { title: "Plumbing Repairs", description: "Beyond drain lines, we handle the full range of plumbing repairs throughout your home with honest assessments and upfront pricing.", href: "/plumbing-repairs" },
    ],
  ...
  },
  {
    ...
    relatedServices: [
      { title: "Backflow Prevention", description: "Annual testing, certification, and installation — licensed and submitted to your water authority.", href: "/backflow-prevention" },
  ...
  },
  {
    ...
    serviceName: "Backflow Prevention",
    serviceCategory: "BACKFLOW PREVENTION SERVICES",
    pageTitle: "Backflow Prevention Services | JMS Plumbing in Broward, Miami-Dade & Palm Beach Counties",
    metaDescription: "Backflow prevention testing, certification, installation & repair in Broward, Miami-Dade & Palm Beach Counties. Licensed, documented & code-compliant. Call (954) 910-6883.",
    heroH1: "Backflow Prevention in South Florida — Protecting Your Water Supply the Right Way.",
    heroSubtext: "Contaminated water flowing back into your drinking supply is not a theoretical risk — it happens, and Florida law requires backflow prevention devices on most commercial and many residential properties for exactly that reason. JMS handles backflow testing, certification, installation, and repair throughout the Tri-County area. Licensed, documented, and done to code.",
    defaultServiceValue: "backflow-prevention",
    introHeading: "Backflow Prevention Services Across South Florida",
    paragraph1: "Most homeowners and property managers don't think about backflow prevention until their municipality sends a compliance notice — or until something goes wrong with their water supply. Backflow is the reversal of normal water flow direction in a plumbing system, which can allow contaminated water from irrigation lines, commercial equipment, or other non-potable sources to flow backward into the clean drinking water supply. In South Florida where large residential properties, commercial buildings, and irrigation systems are common throughout Broward, Miami-Dade, and Palm Beach Counties, the risk is real and the regulatory requirements reflect that.",
    paragraph2: "Florida law requires annual backflow preventer testing and certification on most commercial properties and many residential properties with irrigation systems. Those tests must be performed by a certified backflow prevention device tester and the results submitted to the local water authority. JMS holds the proper certification for backflow prevention work throughout the Tri-County area. We handle the testing, complete the required documentation, and submit the certification reports so you stay compliant without the administrative headache.",
    paragraph3: "Beyond compliance, a properly functioning backflow preventer is what stands between your potable water supply and whatever is on the other side of your irrigation system, pool equipment, or commercial plumbing connections. JMS installs, tests, repairs, and certifies backflow prevention devices on both residential and commercial properties — and we tell you honestly what your system needs before any work begins.",
    signsHeading: "Signs Your Backflow Preventer Needs Attention",
    signs: [
      { text: "Received a compliance notice from your municipality or water authority" },
      { text: "Annual backflow test is overdue or has never been performed" },
      { text: "Noticeable drop in water pressure from your irrigation system" },
      { text: "Visible leaking or dripping from the backflow preventer device" },
      { text: "Discolored or unusual tasting water from interior fixtures" },
      { text: "Backflow preventer is more than five years old and has never been serviced" },
    ],
    diyHeading: "Annual Testing, Certification, Installation & Cross Connection Control",
    diyParagraphs: [
      "Florida municipalities require annual backflow preventer testing to confirm that devices are functioning correctly and preventing contamination of the potable water supply. These tests must be performed by a state certified backflow prevention device tester — not a general plumber — and the results must be submitted to the local water authority within a specified timeframe. Failing to complete annual testing can result in compliance notices, fines, and in some cases water service interruption.",
      "JMS performs annual backflow testing on residential and commercial properties throughout Broward, Miami-Dade, and Palm Beach Counties. We test the device, complete all required documentation, and submit the certification report to your water authority directly. If the device fails the test we tell you immediately, explain what failed and why, and give you a clear price to repair or replace it before moving forward.",
      "A backflow preventer that is failing, leaking, or no longer meeting test standards needs to be repaired or replaced promptly — both for compliance and for the protection of your water supply. We work with all major device types including pressure vacuum breakers, double check valve assemblies, and reduced pressure zone assemblies — recommending the right device for your specific application and local water authority requirements.",
      "Irrigation systems are one of the most common sources of backflow risk in South Florida. Large residential properties throughout the Tri-County area rely on irrigation systems that draw from the same water supply as the home's interior plumbing. Without a properly functioning backflow preventer, a drop in supply pressure can pull irrigation water, fertilizers, pesticides, and soil contaminants backward into the home's drinking water supply. JMS also performs cross connection assessments, identifies unprotected connections, and installs the appropriate backflow prevention device at each point of risk.",
    ],
    expectHeading: "What Happens When You Call JMS for Backflow Prevention Services",
    steps: [
      { title: "You Call and We Assess Your Situation", description: "Whether it's an annual test, a compliance notice, or a new installation — we ask the right questions and determine exactly what your property needs before scheduling." },
      { title: "We Test, Inspect, and Price Upfront", description: "We perform the required testing or assessment, tell you what we found, and give you a clear upfront price for any repair or installation needed before any work begins." },
      { title: "Certified, Documented, Submitted", description: "Work completed to code, certification documentation completed, and reports submitted to your water authority. You stay compliant without the administrative burden." },
    ],
    testimonials: [
      { name: "Stephanie", city: "Sunrise, FL", text: "JMS handled our annual backflow test and submitted the paperwork to the city directly. Showed up on time, explained everything, and we never had to chase the documentation. Easiest compliance task we've ever had.", rating: 5 },
      { name: "Tony", city: "Plantation, FL", text: "Got a compliance notice from the water authority and JMS had a new backflow preventer installed and certified within a week. Fair price and zero hassle.", rating: 5 },
    ],
    faqHeading: "What South Florida Property Owners Ask About Backflow Prevention",
    faqs: [
      { question: "How often does my backflow preventer need to be tested in Florida?", answer: "Florida requires annual backflow preventer testing on most commercial properties and residential properties with irrigation systems connected to the potable water supply. The exact requirement varies by municipality and water authority throughout Broward, Miami-Dade, and Palm Beach Counties — but annual is the standard in most jurisdictions. If you have received a compliance notice or are unsure of your property's requirements, call us at (954) 910-6883 and we'll determine exactly what applies to your address." },
      { question: "What happens if I don't get my backflow preventer tested?", answer: "Consequences vary by municipality but typically include compliance notices, fines, and in some cases water service interruption until testing is completed and certification is submitted. Beyond the regulatory consequences, an untested backflow preventer that has failed provides no protection against contamination of your water supply. Annual testing is both a legal requirement and a genuine safety measure." },
      { question: "My irrigation system backflow preventer is leaking. Do I need to replace the whole device?", answer: "Not necessarily. Many backflow preventer leaks are caused by worn internal seals, debris caught in the check valves, or a failed relief valve — all of which can be repaired without replacing the full device. At JMS we assess the device first and tell you honestly whether a repair will restore it to proper function or whether replacement is the more cost effective solution given the device's age and condition." },
      { question: "I received a compliance notice from my water authority. What do I do?", answer: "Call us at (954) 910-6883 as soon as possible. Compliance notices typically include a deadline for testing or installation — missing that deadline can result in fines or service interruption. We perform the required testing or install the required device, complete all documentation, and submit the certification report to your water authority on your behalf. Most compliance situations can be resolved in a single visit." },
      { question: "Do large residential properties in South Florida need backflow prevention?", answer: "Yes — particularly properties with irrigation systems, pool equipment, or any connection between the potable water supply and a non-potable source. Large residential properties throughout Broward, Miami-Dade, and Palm Beach Counties with complex multi-zone irrigation systems, fertilizer injection equipment, or booster pumps are specifically required to have properly installed and annually tested backflow prevention devices. If your property has never had a backflow assessment, it is worth scheduling one." },
      { question: "What is the difference between back siphonage and backflow?", answer: "Backflow is the general term for any reversal of water flow direction in a plumbing system that can allow contaminated water to enter the potable supply. Back siphonage is a specific type of backflow caused by negative pressure in the supply system — essentially a siphon effect that pulls non-potable water backward through an unprotected connection. Both are prevented by properly installed and maintained backflow prevention devices. Back siphonage is particularly common in irrigation systems where a hose or connection is submerged in water that could be drawn back into the supply line during a pressure drop." },
    ],
    relatedServices: [
      { title: "Plumbing Repairs", description: "Beyond backflow devices, we handle the full range of plumbing repairs on residential and commercial properties with honest assessments and upfront pricing.", href: "/plumbing-repairs" },
      { title: "Gas Line Services", description: "Commercial and large residential properties with gas line infrastructure benefit from the same licensed, code-compliant approach we bring to backflow prevention work.", href: "/gas-line-services" },
      { title: "Septic Services", description: "Licensed septic inspections, leach field repairs, and pump outs throughout Broward, Miami-Dade, and Palm Beach Counties.", href: "/septic-leach-fields" },
    ],
    ctaHeading: "Need Backflow Prevention Services in South Florida? Let's Get You Compliant.",
    ctaSubtext: "Annual testing overdue, compliance notice received, or new installation needed — call JMS for a licensed assessment and upfront pricing. We handle the testing, the documentation, and the submission so you don't have to.",
  },
  {
  ...
  },
  {
    ...
    metaDescription: "Fixture repairs in Broward, Miami-Dade & Palm Beach Counties. JMS Plumbing fixes leaking faucets, running toilets, hose bibs & house mains. Call (954) 910-6883.",
    heroH1: "Leaking Faucet. Running Toilet. Stuck Shut-Off. We Fix It Today.",
    heroSubtext: "Fixture problems are some of the most common plumbing calls we get in South Florida — and most of them are faster and less expensive to fix than homeowners expect. JMS handles toilet repairs, faucet repairs, hose bibs, and house main repairs throughout the Tri-County area with upfront pricing and same day service.",
    defaultServiceValue: "repairs",
    ...
    diyHeading: "Why Small Fixture Problems Become Expensive Ones",
    diyParagraphs: [
