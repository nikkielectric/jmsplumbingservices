...
export const servicePages: ServicePageData[] = [
  {
    ...
    heroH1: "Drain Cleaning in South Florida — Honest Work, Upfront Pricing",
    ...
    introHeading: "Drain Cleaning Services in South Florida",
    paragraph1: "Clogged drains are one of the most common plumbing problems — and one of the most frustrating. Whether it's a slow kitchen sink, a backed-up shower, or a main sewer line blockage, JMS Plumbing Services has the tools and experience to clear it fast and get your water flowing again.",
    paragraph2: "South Florida's unique plumbing challenges make drain cleaning especially important. Hard water mineral buildup, tree root intrusion from tropical landscaping, and older cast iron pipes all contribute to recurring blockages. Our team understands these local conditions and uses the right approach for each situation.",
    paragraph3: "At JMS, we don't just clear the clog — we diagnose why it happened and explain what you can do to prevent it. Every drain cleaning comes with a clear upfront price, a thorough explanation, and a clean work area when we leave.",
    signsHeading: "Signs You May Need Drain Cleaning",
    signs: [
      { text: "Water draining slowly in sinks, tubs, or showers" },
      { text: "Gurgling sounds coming from your drains" },
      { text: "Unpleasant odors near sinks or floor drains" },
      { text: "Water backing up in multiple fixtures" },
      { text: "Recurring clogs despite using store-bought products" },
      { text: "Standing water in your yard near the sewer line" },
    ],
    diyHeading: "Why Not DIY? Here's What's at Stake.",
    diyParagraphs: [
      "Chemical drain cleaners from the store might seem like a quick fix, but they can corrode your pipes from the inside — especially if you have older cast iron or galvanized plumbing common in South Florida homes. One bottle might clear the surface clog, but the real blockage often sits deeper in the line.",
      "Professional drain cleaning uses hydro-jetting and mechanical snaking to fully clear the line without damaging your plumbing. A licensed plumber can also identify underlying issues like root intrusion or pipe deterioration before they turn into a costly emergency.",
    ],
    ...
    steps: [
      ...
      { title: "We arrive on time and assess the issue — upfront price before we start", description: "We diagnose the clog and explain exactly what it'll cost before we begin." },
      { title: "Work completed, area cleaned, follow-up to make sure you're satisfied", description: "Drain cleared, area spotless, and we check back to make sure it stays that way." },
    ],
    testimonials: [
    ...
    faqHeading: "Frequently Asked Questions About Drain Cleaning in South Florida",
    faqs: [
