...
export const servicePages: ServicePageData[] = [
  ...
  },
  {
    ...
    serviceCategory: "SEPTIC LEACH FIELD SERVICES",
    pageTitle: "Septic Leach Field Services | JMS Plumbing in Broward, Miami-Dade & Palm Beach Counties",
    metaDescription: "Licensed septic leach field services in Broward, Miami-Dade & Palm Beach Counties. Inspections, repairs & restorations. JMS Plumbing — call (954) 910-6883.",
    heroH1: "Septic Problems in South Florida Are Different. You Need Someone Who Knows Why.",
    heroSubtext: "South Florida's high water table, sandy soil, and subtropical climate create septic conditions unlike anywhere else in the country. JMS is licensed for septic leach field services throughout the Tri-County area — inspections, repairs, and restorations handled correctly and to code.",
    defaultServiceValue: "septic",
    introHeading: "Septic Leach Field Services Across South Florida",
    paragraph1: "A septic leach field — also called a drain field — is the underground system that receives and filters wastewater after it leaves your septic tank. When it's working correctly you never think about it. When it starts to fail the signs are hard to miss: soggy ground above the field, sewage odors in your yard, slow drains throughout the house, or sewage backing up into your lowest fixtures. At that point the situation requires a licensed septic contractor, not a general handyman or an unlicensed plumber.",
    paragraph2: "South Florida presents unique challenges for septic systems that homeowners in other parts of the country simply don't deal with. The region's high water table means leach fields have less vertical separation from groundwater than systems in drier climates, which limits the soil's ability to filter effluent and makes the system more vulnerable to saturation during heavy rainfall. South Florida's sandy soil drains quickly under normal conditions but can become compacted or clogged with biomat — a layer of organic material that forms when a system is overloaded or poorly maintained. And the subtropical climate creates ideal conditions for root intrusion from the aggressive tree and plant growth common throughout Broward, Miami-Dade, and Palm Beach Counties.",
    paragraph3: "JMS holds the proper licensing for septic leach field work in Florida. Every septic job we handle is assessed thoroughly, priced honestly upfront, and completed to Florida Department of Health standards. We'll tell you exactly what's happening with your system, what your options are, and what the work involves before any decisions are made.",
    signsHeading: "Signs Your Leach Field May Be Failing",
    signs: [
      { text: "Soggy or unusually wet ground directly above the leach field area" },
      { text: "Sewage or rotten egg odor in your yard, particularly near the drain field" },
      ...
      { text: "Unusually lush or green grass growing directly over the leach field" },
      { text: "Gurgling sounds from drains when no water is running" },
    ],
    diyHeading: "Why South Florida Leach Fields Fail Faster",
    diyParagraphs: [
      "The two most common causes of leach field failure in South Florida are biomat buildup and high water table saturation. Biomat is a natural byproduct of the septic process — a layer of organic material that forms at the interface between the leach field pipes and the surrounding soil. Over time it can restrict the soil's ability to absorb effluent, causing the system to back up. In South Florida's warm, moist climate biomat develops faster than in cooler, drier regions.",
      "High water table saturation is a seasonal issue throughout much of Broward, Miami-Dade, and Palm Beach Counties. During periods of heavy rainfall the water table rises significantly in South Florida, which can temporarily overwhelm a leach field's capacity even in a well maintained system. A system that's already under stress from biomat buildup or age is particularly vulnerable during the rainy season. Understanding how your specific system is positioned relative to the local water table is part of what a proper septic assessment includes.",
      "Root intrusion is the third major factor. South Florida's aggressive tropical and subtropical plant growth means tree and shrub roots actively seek out the moisture and nutrients in leach field pipes. Once roots enter the system they grow quickly, displace soil, crush or crack pipes, and can cause complete field failure if left unaddressed.",
    ],
    expectHeading: "What Happens When You Call JMS for Leach Field Service",
    steps: [
      { title: "You Call and Describe What You're Seeing", description: "Wet yard, slow drains, sewage odors — we ask the right questions and schedule a proper assessment of your septic system." },
      { title: "Full Assessment, Honest Recommendation, Upfront Price", description: "We evaluate the full system, identify what's causing the problem, and give you a clear price before any work begins. No pressure, no inflated estimates." },
      { title: "Work Completed to Florida Code", description: "Every septic leach field job is completed to Florida Department of Health standards by a licensed septic contractor. Properly done and fully documented." },
    ],
    testimonials: [
    ...
    faqs: [
      { question: "How do I know if my problem is the septic tank or the leach field?", answer: "Both can cause similar symptoms — slow drains, sewage backups, and odors. Generally speaking, a full or failing septic tank causes backups and slow drains relatively quickly after pumping. A failing leach field causes persistent problems that don't fully resolve even after the tank is pumped. The distinction matters because the repair is completely different. A proper assessment by a licensed septic contractor is the only reliable way to determine which part of your system is the problem." },
      { question: "Can a leach field be repaired or does it need to be fully replaced?", answer: "It depends on the cause and extent of the failure. Some leach field problems — biomat buildup in early stages, minor root intrusion, or a single damaged distribution pipe — can be addressed with targeted repairs or restoration treatments. More advanced failure, significant root damage, or a field that has reached the end of its design life typically requires replacement. At JMS we assess the full system before recommending anything. We're not going to tell you that you need a full replacement if a repair will genuinely solve the problem." },
      { question: "How long do septic leach fields last in South Florida?", answer: "A properly designed and maintained leach field typically has a lifespan of twenty to thirty years. In South Florida that lifespan can be shortened by the region's high water table, aggressive root growth, and the subtropical climate's effect on biomat development. Systems that are overloaded, poorly maintained, or located in areas with high seasonal water table fluctuation often show signs of stress earlier. Regular septic tank pumping — every three to five years for most households — is the single most important maintenance step for extending leach field life." },
      { question: "Does Florida require a license for septic leach field work?", answer: "Yes. Septic system work in Florida is regulated by the Florida Department of Health and requires a licensed septic contractor separate from a standard plumbing license. JMS holds the proper licensing for septic leach field work in the Tri-County area. Florida Septic Contractor License: (insert license number before launch). Always verify licensing before hiring anyone for septic work — unpermitted septic repairs can result in significant fines and may complicate property sales." },
      { question: "Can heavy rainfall affect my septic leach field in South Florida?", answer: "Yes and this is a South Florida specific concern that homeowners in other parts of the country rarely deal with. During the rainy season South Florida's water table rises significantly throughout Broward, Miami-Dade, and Palm Beach Counties. When the water table rises close to the level of the leach field the soil loses its capacity to absorb effluent, which can cause temporary system backup even in a healthy, well maintained system. If you experience septic problems specifically during or after heavy rainfall periods your system may need to be assessed for proper depth and drainage relative to your local water table conditions." },
      { question: "What should I avoid putting into my septic system in South Florida?", answer: "The basics apply everywhere — no grease, no wipes labeled flushable, no harsh chemical drain cleaners that kill the beneficial bacteria your septic system depends on. In South Florida specifically, be mindful of water usage during the rainy season when the water table is elevated and your leach field has less capacity. Spreading laundry loads throughout the week rather than doing multiple loads in a single day reduces the hydraulic load on the system. And avoid planting trees or large shrubs anywhere near your leach field — South Florida's aggressive root growth will find the system." },
    ],
    relatedServices: [
    ...
    ctaHeading: "Septic Problems in South Florida? Don't Wait on This One.",
    ctaSubtext: "Leach field issues get significantly more expensive the longer they go unaddressed. Call JMS for a licensed assessment and honest recommendation. We'll tell you exactly what's happening and what it will take to fix it before any work begins.",
  },
  {
    ...
    heroH1: "Leaking Faucet. Running Toilet. Broken Hose Bib. We Fix It Today.",
    ...
    diyParagraphs: [
      "A faucet that drips once per second wastes more than 3,000 gallons of water per year. In South Florida where water bills are already high, that adds up fast. More importantly, fixtures that drip or leak slowly almost never get better on their own. The internal components continue to wear and what starts as a minor fix becomes a full replacement if it's left too long.",
    ...
    faqs: [
      { question: "How do I know if my faucet needs a repair or a full replacement?", answer: "In most cases a dripping or leaking faucet can be repaired by replacing the internal cartridge, washer, or O-ring. If the faucet body itself is cracked, severely corroded, or the repair cost approaches the cost of a new fixture, replacement makes more sense. At JMS we assess the fixture and give you an honest recommendation either way. We're not in the business of replacing things that can be fixed." },
      { question: "My toilet keeps running after I flush. Is that a big repair?", answer: "Usually not. A constantly running toilet is almost always a worn flapper, a faulty fill valve, or a float that needs adjustment. These are among the most straightforward plumbing repairs we handle and can typically be completed in under an hour. The bigger issue is what it costs you if you leave it — a running toilet can waste up to 200 gallons of water per day on your water bill." },
      { question: "What is a hose bib and how do I know if mine needs replacing?", answer: "A hose bib is the outdoor spigot on the exterior of your home where you connect a garden hose. Signs that yours needs attention include water dripping from the spout even when fully turned off, leaking around the handle when the water is on, or visible corrosion and rust on the body of the fixture. In South Florida salt air accelerates corrosion on outdoor fixtures significantly. A failing hose bib is worth replacing before it fails completely and causes water damage to your exterior wall." },
      { question: "My house main shut off valve is stuck and won't turn. Is that a problem?", answer: "Yes and it is worth addressing before an emergency happens. A stuck house main shut off is one of the most dangerous situations a homeowner can face during a plumbing emergency because it means you cannot stop the water flow to your home if a pipe bursts or a fixture fails. In South Florida many older homes have gate valves that corrode and seize over time. Replacing a stuck gate valve with a modern ball valve is a straightforward job that could save thousands in water damage down the road." },
      ...
      { question: "Can hard water in South Florida really damage my fixtures that quickly?", answer: "Yes. Florida's water carries one of the highest mineral content levels in the country. Calcium and magnesium deposits build up inside faucet aerators, clog showerheads, wear down cartridge seals, and corrode valve seats faster than most homeowners realize. A fixture that might last fifteen years in a low mineral content area may show significant wear in eight to ten years in a South Florida home. Regular inspection and timely repairs extend fixture life considerably." },
    ],
    relatedServices: [
