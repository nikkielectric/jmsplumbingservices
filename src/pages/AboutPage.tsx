...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* ═══ SECTION 1 — PAGE HERO ═══ */}
      <section className="relative pt-36 lg:pt-44 bg-secondary vintage-grain vintage-vignette pb-0">
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center pb-12 lg:pb-16">
