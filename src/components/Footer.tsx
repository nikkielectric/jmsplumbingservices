        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-[3fr_1fr_1fr_1fr] gap-10 lg:gap-24 mb-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-5">
              ...
              <a href="https://www.yelp.com/biz/jms-plumbing-services-sunrise" target="_blank" rel="noopener noreferrer" className="text-cream/50 hover:text-cream transition-colors" aria-label="Yelp">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.16 12.594l-4.995 1.433c-.96.276-1.74-.8-1.176-1.63l2.905-4.308a1.072 1.072 0 011.596-.206 7.26 7.26 0 012.054 3.128 1.074 1.074 0 01-.384 1.583zm-3.996 5.882a1.072 1.072 0 01-1.632-.014l-2.806-4.39c-.548-.858.26-1.906 1.22-1.583l5.042 1.684a1.072 1.072 0 01.46 1.573 7.26 7.26 0 01-2.284 2.73zm-7.92-.393l1.06-5.095c.202-.972 1.556-1.08 1.904-.152l1.836 4.868a1.072 1.072 0 01-.72 1.42 7.259 7.259 0 01-3.54.004 1.072 1.072 0 01-.54-1.045zm-1.348-6.785c.016 1-.92 1.648-1.836 1.264L.42 10.678A1.074 1.074 0 01.01 9.082a7.276 7.276 0 013.2-2.574 1.072 1.072 0 011.617.748l.069 5.042zm1.87-3.065L11.1 3.397c.416-.886 1.776-.632 1.85.346l.397 5.152c.074.986-1.09 1.528-1.776.83l-3.334-3.4a1.072 1.072 0 01.529-1.293z"/></svg>
              </a>
              <a href="https://www.angi.com/companylist/us/fl/sunrise/jms-plumbing-services-llc-reviews-1.htm" target="_blank" rel="noopener noreferrer" className="text-cream/50 hover:text-cream transition-colors" aria-label="Angi">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm3.248 16.89h-2.62l-.467-1.567H9.84l-.468 1.567H6.752L9.97 7.11h2.06l3.218 9.78zm-3.598-3.567l-1.15-3.85-1.15 3.85h2.3z"/></svg>
              </a>
            </div>
          </div>
