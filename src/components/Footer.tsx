        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-[3fr_1fr_1fr_1fr] gap-10 lg:gap-24 mb-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-5">
              ...
              <a href="https://www.yelp.com/biz/jms-plumbing-services-sunrise" target="_blank" rel="noopener noreferrer" className="opacity-50 hover:opacity-100 transition-opacity" aria-label="Yelp">
                <img src={yelpIcon} alt="Yelp" className="w-5 h-5 brightness-0 invert" />
              </a>
              <a href="https://www.angi.com/companylist/us/fl/sunrise/jms-plumbing-services-llc-reviews-1.htm" target="_blank" rel="noopener noreferrer" className="opacity-50 hover:opacity-100 transition-opacity" aria-label="Angi">
                <img src={angiIcon} alt="Angi" className="w-5 h-5 brightness-0 invert" />
              </a>
            </div>
          </div>
