...
const Hero = () => {
  return (
    <section className="relative pt-20 bg-secondary vintage-grain vintage-vignette">
      {/* Main hero content */}
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-20">
          ...
          >
            {/* Rating badge */}
            <div className="inline-flex items-center gap-3 bg-cream/10 backdrop-blur-sm border border-cream/20 rounded-full px-5 py-2.5 mb-6">
